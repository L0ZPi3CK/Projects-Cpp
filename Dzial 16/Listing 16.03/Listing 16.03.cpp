...
{
    "agrest","bigos","czara","drewno","ekipa",
    "figura","gorycz","hiena","iskra","junior",
    "krata","lizak","miska","nurek","obuwie",
    "pisak","rozum","smalec","taryfa","umiar",
...
int main()
{
    ...
    char play;
    cout << "Czy chcesz zagrac w gre slowna? <t\\n> ";
    cin >> play;
    play = tolower(play);
    ...
    while (play == 't')
    {
        ...
        while (guesses > 0 && attempt != target)
        {
            ...
            {
                cout << "Ta litera juz byla. Sproboj innej.\n";
                continue;
            }
            ...
            else
            {
                ...
                attempt[loc] = letter;
                // sprawdza czy litera nie pojawia sie ponownie w innym miejscu
